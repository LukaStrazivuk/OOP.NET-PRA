...
namespace Projekt
{
    public partial class RangListeWomen : Form
    {
        ...
        public RangListeWomen(List<StartingEleven> lista)
        {
            InitializeComponent();
        ...
        private void promijeniNacijuToolStripMenuItem_Click(object sender, EventArgs e)
        {
            string women = "women";
            new Postavke(women).Show();
            this.Hide();
        }
